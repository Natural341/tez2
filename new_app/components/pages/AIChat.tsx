...
const AIChat: React.FC = () => {
    ...
    const [messages, setMessages] = useState<ChatMessage[]>([
        {
            id: 'init',
            role: 'assistant',
            content: 'Merhaba! Ben StatFlow gelişmiş analiz asistanı. Veri setleriniz, SQL sorgularınız veya istatistiksel modelleriniz hakkında her şeyi sorabilirsiniz. Size nasıl yardımcı olabilirim?',
            timestamp: new Date()
        }
    ]);
    ...
    const handleSubmit = async (e: React.FormEvent) => {
        ...
        const context = "Kullanıcı şu an Tam Ekran Sohbet modunda."; 
    ...
    return (
        <div className="h-[calc(100vh-8rem)] flex flex-col bg-white border border-slate-200 rounded-xl shadow-sm overflow-hidden animate-fade-in">
            ...
            <div className="bg-white border-b border-slate-100 p-4 flex items-center gap-4">
                ...
                <div>
                    <h2 className="text-lg font-bold text-slate-900">AI Asistan</h2>
                    <p className="text-xs text-slate-500 flex items-center gap-1">
                        <Sparkles size={12} className="text-indigo-500"/> Gemini 1.5 Pro Powered
                    </p>
                </div>
            </div>
                    ...
                    <div className="flex justify-start">
                         <div className="flex gap-4 max-w-3xl">
                            ...
                            <div className="bg-white border border-slate-200 px-6 py-4 rounded-2xl rounded-tl-none shadow-sm flex items-center gap-3">
                                ...
                                <span className="text-sm text-slate-500 font-medium">Yanıt oluşturuluyor...</span>
                            </div>
                        </div>
                    </div>
                )}
            ...
            <div className="p-6 bg-white border-t border-slate-100">
                <form onSubmit={handleSubmit} className="relative max-w-4xl mx-auto">
                    <input 
                        ...
                        placeholder="Karmaşık analiz soruları sorun..."
                ...
                <p className="text-center text-[10px] text-slate-400 mt-3">
                    AI, istatistiksel analizlerde hata yapabilir. Önemli kararları her zaman manuel verilerle doğrulayın.
                </p>
            </div>
        </div>
    );
