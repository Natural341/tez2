        ...
        <div>
          ...
          <p className="text-sm text-slate-500">
            {analysisType === AnalysisType.FORECAST 
                ? 'AI tabanlı gelecek 15dk projeksiyonu' 
                : 'Gerçek zamanlı veri akışı ve karşılaştırma'}
          </p>
        </div>
        <div className="flex items-center gap-4 text-xs font-medium">
            <div className="flex items-center gap-2">
                <span className="w-2 h-2 rounded-full bg-indigo-500"></span> Grup A (Target)
            </div>
            <div className="flex items-center gap-2">
                <span className="w-2 h-2 rounded-full bg-sky-400"></span> Grup B (Control)
            </div>
        </div>
      </div>
