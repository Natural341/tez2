...
import { generateSQLFromText } from '@/lib/ai/dashboard-ai';
...
const SQLStudio: React.FC = () => {
    ...
    return (
        <div className="animate-fade-in pb-10 h-full flex flex-col">
             <div className="mb-6">
                <h2 className="text-2xl font-bold text-slate-900 tracking-tight">SQL Studio (NL2SQL)</h2>
                <p className="text-slate-500 mt-1">Generate and optimize database queries using natural language.</p>
             </div>
                ...
                <div className="w-1/2 flex flex-col gap-4">
                    <div className="flex-1 bg-white border border-slate-200 rounded-xl p-6 shadow-sm flex flex-col">
                        <label className="text-sm font-bold text-slate-700 mb-4 flex items-center gap-2">
                             Query Request (Natural Language)
                        </label>
                        <textarea 
                            value={query}
                        ...
                        <div className="flex-1 overflow-auto font-mono text-sm leading-relaxed">
                            {generatedSQL ? (
                                ...
                                <div className="h-full flex flex-col items-center justify-center text-slate-600">
                                    ...
                                    <span className="text-xs">SQL output will appear here...</span>
                                </div>
                            )}
                        </div>
                    </div>
